<?php
require CONTAINER_PATH.'/app/application/project/forms/admin/index.php';
class Project_AdminController extends Zend_Controller_Action
{
	...
	{
		session_destroy();
		$this->_redirect('/project/admin/index/');
	}
}