<?php
require CONTAINER_PATH.'/app/application/project/forms/type/Edit.php';
class Project_TypeController extends Zend_Controller_Action
{
	private $_tb;
	private $_form;
	...
	{	
		...
		$partialHTML = $this->view->partial('select-search-header-front.phtml', array(
				...
				'url' => '/project/type/get-form-json/',
				'actionId' => 'id',
				'click' => array(
						'action' => 'contextMenu',
						'menuItems' => array(
								array('详情', '/project/tschedule/index/id/'),
								array('编辑', '/project/type/edit/id/'),
								array('删除', '/project/type/del/id/')
						)
				),
				'initSelectRun' => 'true',
				'hashParam' => $hashParam
	...
	public function createAction()
	{
		...
		if($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getParams())) {
			...
			$this->_redirect('/project/type/add/id/'.$type);
		}
		$this->view->form = $form;
	}
	...
	public function editAction()
	{
		...
		if($this->getRequest()->isPost() && $html->isValid($this->getRequest()->getParams())) {
			...
			$this->_redirect('/project/type/index/');
		}	
		$this->view->html = $html;
	}
